...
public class RegisterActivityTestPassShort {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void registerActivityTestPassShort() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.etxtPassword),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("giaco"), closeSoftKeyboard());

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.etxtPassword), withText("giaco"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.etxtConfirmPassword),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("giaco"), closeSoftKeyboard());

        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.etxtConfirmPassword), withText("giaco"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.etxtPassword), withText("giaco"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        editText2.check(matches(withText("giaco")));

        ViewInteraction editText3 = onView(
                allOf(withId(R.id.etxtConfirmPassword), withText("giaco"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        editText3.check(matches(withText("giaco")));
